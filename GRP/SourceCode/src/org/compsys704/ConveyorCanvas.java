...
//			conveyor = ImageIO.read(new File("res/conveyor.png"));
			...
			conveyorEmpty = ImageIO.read(new File("res/704_conveyor_empty.png"));
			...
			conveyorEmpty_resized = conveyorEmpty.getScaledInstance(newWidth, newHeight, Image.SCALE_DEFAULT);
		} catch (IOException e) {
			e.printStackTrace();
			System.exit(1);;
		}
	...
	protected void paintComponent(Graphics g){
		...
		g.drawImage(conveyorEmpty_resized, x1, y1, null);
